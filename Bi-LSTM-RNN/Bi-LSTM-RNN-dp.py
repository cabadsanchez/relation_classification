...
concat_before = concatenate([beforeLstmDp, beforeLstm_backDp])
concat_former = concatenate([formerLstmDp, formerLstm_backDp])
concat_middle = concatenate([middleLstmDp, middleLstm_backDp])
concat_latter = concatenate([latterLstmDp, latterLstm_backDp])
concat_after = concatenate([afterLstmDp, afterLstm_backDp])
