...
wordsLSTM_1_1 = LSTM(num_cells_words, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(wordsEmbeddings_1)
lemmasLSTM_1_1 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(lemmasEmbeddings_1)
posTagsLSTM_1_1 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(posTagsEmbeddings_1)
hypernymsLSTM_1_1 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(hypernymsEmbeddings_1)

wordsLSTM_2_1 = LSTM(num_cells_words, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(wordsEmbeddings_2)
lemmasLSTM_2_1 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(lemmasEmbeddings_2)
posTagsLSTM_2_1 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(posTagsEmbeddings_2)
hypernymsLSTM_2_1 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(hypernymsEmbeddings_2)
...
wordsLSTM_1_2 = LSTM(num_cells_words, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(wordsLSTM_1_1)
lemmasLSTM_1_2 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(lemmasLSTM_1_1)
posTagsLSTM_1_2 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(posTagsLSTM_1_1)
hypernymsLSTM_1_2 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(hypernymsLSTM_1_1)

wordsLSTM_2_2 = LSTM(num_cells_words, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(wordsLSTM_2_1)
lemmasLSTM_2_2 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(lemmasLSTM_2_1)
posTagsLSTM_2_2 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(posTagsLSTM_2_1)
hypernymsLSTM_2_2 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(hypernymsLSTM_2_1)
...
wordsLSTM_1_3 = LSTM(num_cells_words, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(wordsLSTM_1_2)
lemmasLSTM_1_3 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(lemmasLSTM_1_2)
posTagsLSTM_1_3 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(posTagsLSTM_1_2)
hypernymsLSTM_1_3 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(hypernymsLSTM_1_2)

wordsLSTM_2_3 = LSTM(num_cells_words, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(wordsLSTM_2_2)
lemmasLSTM_2_3 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(lemmasLSTM_2_2)
posTagsLSTM_2_3 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
                  kernel_regularizer=reg)(posTagsLSTM_2_2)
hypernymsLSTM_2_3 = LSTM(num_cells_embed, return_sequences=True, dropout=.25, recurrent_dropout=.25,
