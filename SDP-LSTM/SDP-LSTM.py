...
wordsLSTM_1_1 = LSTM(num_cells_words, return_sequences=True)(wordsEmbeddings_1)
lemmasLSTM_1_1 = LSTM(num_cells_embed, return_sequences=True)(lemmasEmbeddings_1)
posTagsLSTM_1_1 = LSTM(num_cells_embed, return_sequences=True)(posTagsEmbeddings_1)
hypernymsLSTM_1_1 = LSTM(num_cells_embed, return_sequences=True)(hypernymsEmbeddings_1)

wordsLSTM_2_1 = LSTM(num_cells_words, return_sequences=True)(wordsEmbeddings_2)
lemmasLSTM_2_1 = LSTM(num_cells_embed, return_sequences=True)(lemmasEmbeddings_2)
posTagsLSTM_2_1 = LSTM(num_cells_embed, return_sequences=True)(posTagsEmbeddings_2)
hypernymsLSTM_2_1 = LSTM(num_cells_embed, return_sequences=True)(hypernymsEmbeddings_2)
...
wordsLSTM_1_2 = LSTM(num_cells_words, return_sequences=True)(wordsLSTM_1_1)
lemmasLSTM_1_2 = LSTM(num_cells_embed, return_sequences=True)(lemmasLSTM_1_1)
posTagsLSTM_1_2 = LSTM(num_cells_embed, return_sequences=True)(posTagsLSTM_1_1)
hypernymsLSTM_1_2 = LSTM(num_cells_embed, return_sequences=True)(hypernymsLSTM_1_1)

wordsLSTM_2_2 = LSTM(num_cells_words, return_sequences=True)(wordsLSTM_2_1)
lemmasLSTM_2_2 = LSTM(num_cells_embed, return_sequences=True)(lemmasLSTM_2_1)
posTagsLSTM_2_2 = LSTM(num_cells_embed, return_sequences=True)(posTagsLSTM_2_1)
hypernymsLSTM_2_2 = LSTM(num_cells_embed, return_sequences=True)(hypernymsLSTM_2_1)
...
wordsLSTM_1_3 = LSTM(num_cells_words, return_sequences=True)(wordsLSTM_1_2)
lemmasLSTM_1_3 = LSTM(num_cells_embed, return_sequences=True)(lemmasLSTM_1_2)
posTagsLSTM_1_3 = LSTM(num_cells_embed, return_sequences=True)(posTagsLSTM_1_2)
hypernymsLSTM_1_3 = LSTM(num_cells_embed, return_sequences=True)(hypernymsLSTM_1_2)

wordsLSTM_2_3 = LSTM(num_cells_words, return_sequences=True)(wordsLSTM_2_2)
lemmasLSTM_2_3 = LSTM(num_cells_embed, return_sequences=True)(lemmasLSTM_2_2)
posTagsLSTM_2_3 = LSTM(num_cells_embed, return_sequences=True)(posTagsLSTM_2_2)
hypernymsLSTM_2_3 = LSTM(num_cells_embed, return_sequences=True)(hypernymsLSTM_2_2)
